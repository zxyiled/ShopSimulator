...
class InventoryControllerTest {
    ...
    class UpdateStock {
        ...
        @Test
        @DisplayName("Returns 400 when operation is unknown")
            // Covers the default branch of the switch expression
        void unknownOperation() {
            StockRequest req = new StockRequest("delete", 5);
        ...
        @Test
        @DisplayName("Returns 400 when stock operation fails")
        void stockOperationFails() {
            // Trying to reduce more than available stock
            StockRequest req = new StockRequest("reduce", 999);
        ...
        @Test
        @DisplayName("Returns 400 when product code does not exist")
        void nonExistentProduct() {
            StockRequest req = new StockRequest("augment", 5);

            ResponseEntity<ApiResponse<Product>> response = controller.updateStock("FAKE", req);
